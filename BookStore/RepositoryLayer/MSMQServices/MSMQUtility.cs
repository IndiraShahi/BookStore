...
namespace RepositoryLayer.MSMQServices
{
    public class MSMQUtility
    {
        ...
        private void ReceiveCompletedMSMQ(object sender, ReceiveCompletedEventArgs e)
        {
            ...
            using (MailMessage mailMessage = new MailMessage("indirashahi144@gmail.com", email))
            {
                ...
                smtp.Credentials = new NetworkCredential("indirashahi144@gmail.com", "bachan@1956");
                smtp.Port = 587;
        ...
        {
            var key = Encoding.ASCII.GetBytes("bookstore online app made by Indira Shahi");
